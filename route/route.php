...
Route::group('admin', [
    ...
    //建言献策
    'suggestList$'=>'admin/suggest/suggestList',

    //缘定工会
    'activityList'=>'admin/activity/activityList',
    'activityEdit$'=>'admin/activity/edit',
    'activityDelete$'=>'admin/activity/delete'
...
//Route::rule('admin/messageList','admin/Message/messageList?category=1')->ext('html');
return [
];
